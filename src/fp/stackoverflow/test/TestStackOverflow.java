...
public class TestStackOverflow {
	...
	public static void main(String[] args) {
		...
		StackOverflow s1 = new StackOverflow(1, StatusProfesional.STUDENT, "Spain", StatusEmpleo.UNEMPLOYED_NOT_LOOKING, "Yes", null, null, null);
		...
		StackOverflow s3 = new StackOverflow(-1, StatusProfesional.STUDENT, "Spain", StatusEmpleo.UNEMPLOYED_NOT_LOOKING, "Yes", null, null, null);
		Integer pos_s3 = s3.getPosicion();
		// s3.posicionInvalida(pos_s3); // Prueba excepción de posición
		
		StackOverflow s4 = new StackOverflow(1, StatusProfesional.STUDENT, null, StatusEmpleo.UNEMPLOYED_NOT_LOOKING, "Yes", null, null, null);
